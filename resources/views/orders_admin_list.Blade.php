...
@section('admincontent')
    <div class="container-fluid px-3 d-flex justify-content-between align-items-center"
        style="height: 75px;">
        <div class="col-2 admin-title">Заказы</div>
        ...
        <div class="border-type-2">
            ...
            <div class="container-fluid px-4 d-flex justify-content-between align-items-center"
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button class="btn-add px-4 me-3">Добавить Заказ</button>
            ...
            <div class="container-fluid px-4">
                <table class="table table-hover">
                    <tr style="background: #EEF2F7;">
                        ...
                        <td class="col th-type-1">Услуга</td>
                        <td class="col th-type-1">Клиент</td>
                        <td class="col th-type-1">Исполнитель</td>
                        <td class="col th-type-1">Получено</td>
                    ...
                    <tr class="">
                        ...
                        <td class="col th-type-1 text-grey-3 text-nunito fs-14 fw-light text-truncate" style="max-width: 193.4px; max-height: 55.9px;">Установка на хостинг
                        </td>
                        <td class="col th-type-1 text-grey-3 text-nunito fs-15 fw-bolder">Иван Иванович
                        </td>
                        ...
                        <td class="col th-type-1">
                            <div class="rounded-2 text-center fs-12 fw-bolder col-10"
                                style="background-color: rgba(57,175,209,.18); color: #39AFD1">Ожидание оплаты
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="col th-type-1 text-grey-3 text-nunito fs-14 fw-light text-truncate" style="max-width: 193.4px; max-height: 55.9px;">Исправление ошибок
                        </td>
                        <td class="col th-type-1 text-grey-3 text-nunito fs-15 fw-bolder">Петр Петрович
                        </td>
                        <td class="col th-type-1 text-grey-3 text-nunito fs-15 fw-bolder">Дамир Хайбулин
                        </td>
                        ...
                        <td class="col th-type-1">
                            <div class="rounded-2 text-center fs-12 fw-bolder col-8"
                                style="background-color: rgba(255, 195, 90, 0.18); color: rgb(255, 195, 90)">В работе
                            </div>
                        </td>
                        <td class="col th-type-1 d-flex justify-content-start" style="color:#6C757D;">
                            <div class="ms-2">
                    ...
                    <tr>
                        ...
                        <td class="col th-type-1 text-grey-3 text-nunito fs-14 fw-light text-truncate" style="max-width: 193.4px; max-height: 55.9px;">Сайд под ключ
                        </td>
                        <td class="col th-type-1 text-grey-3 text-nunito fs-15 fw-bolder">Андрей Петрович
                        </td>
                        ...
                        <td class="col th-type-1">
                            <div class="rounded-2 text-center fs-12 fw-bolder col-6"
                                style="background-color: rgba(10,207,151,.18); color: #0acf97">Готово
                            </div>
                        </td>
                        <td class="col th-type-1 d-flex justify-content-start" style="color:#6C757D;">
                            <div class="ms-2">
