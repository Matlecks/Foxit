        ...
        <div class="border-type-2">
            ...
            <div class="container-fluid px-4 d-flex justify-content-between align-items-center"
                ...
                <div class="col-4 d-flex justify-content-end">
                    <a href="{{ route('AddPageUser', $title = 'Пользователь') }}"><button
                            class="btn-add px-4 me-3" type="button" data-bs-target="#AddEdit"
                            data-bs-toggle="modal">Добавить Пользователя</button></a>
            ...
            <div class="container-fluid px-4">
                <table class="table table-hover">
                    <tr style="background: #EEF2F7;">
                        ...
                        <td class="col th-type-1">Login</td>
                    ...
                    @foreach ($users as $user)
                        <tr class="">
                            ...
                            <td class="col th-type-1 dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item"
                                            href="{{ route('EditPageUser', $user->id) }}">Изменить</a>
                                    </li>
                                    <li>
                                        <form action="{{ route('UserRestore', $user->id) }}"
                                            method="post">
                                            {{-- @method('PUT') --}}
                                            @csrf
                            ...
                            <td class="col th-type-1 text-grey-3 text-nunito fs-14 fw-bolder">
                                {{ $user->id }}</td>
                            <td class="col th-type-1 text-grey-3 text-nunito fs-14 fw-light">{{ $user->login }}
                            </td>
