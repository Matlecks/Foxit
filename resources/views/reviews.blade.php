...
@section('companycontent')
    <div class="">
        <div class="d-flex flex-wrap justify-content-between p-5"
            ...
            <div class="d-flex justify-content-lg-start justify-content-center col-lg-1 col-md-1 col-12">
            ...
            <div class="d-flex flex-wrap justify-content-between col-lg-11 col-md-10 col-12 ">
                <div class="text-montserrat fs-15 text-darkgrey col-lg-8 col-md-12 col-12 pt-lg-0 pt-md-0 pt-4"
                    style="line-height: 25px;">Мы
                    благодарны
                ...
                <div class="col-lg-4 col-md-12 col-12 text-lg-end text-md-start text-center">
                    <button type="submit"
                        class="rounded-1 fs-14 fw-bold text-montserrat mt-lg-0 mt-4 px-4 py-3 text-white"
    ...
    @foreach ($reviews as $review)
        <div class="p-5 mt-5" style="border: 1px solid #E5E5E5; border-radius: 4px;">
            <div class="d-flex flex-wrap justify-content-between">
                <div class="d-flex justify-content-lg-start justify-content-start col-lg-11 col-lg-10 col-md-10 col-12">
                    <div class="rounded-circle col-lg-1 col-1" style="width: 60px; height: 60px;"><img
                            src="/storage/{{ User::find($review->users_id)->avatar }}"
                            class="rounded-circle"
                            style="width: 100%; height: 100%; object-fit: cover;">
                    </div>
                    <div class="col-lg-10 col-9 ms-lg-4 ms-4">
                ...
                <div class="d-flex justify-content-between col-lg-1 col-md-2 col-5 mt-lg-0 mt-md-0 mt-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#E5C45B"
