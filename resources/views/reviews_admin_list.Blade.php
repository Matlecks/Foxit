        ...
        <div class="border-type-2">
            ...
            <div class="container-fluid px-4 d-flex justify-content-between align-items-center"
                ...
                <div class="col-4 d-flex justify-content-end">
                    <button class="btn-add px-4 me-3">Добавить Отзыв</button>
            ...
            <div class="container-fluid px-4">
                <table class="table table-hover">
                    <tr style="background: #EEF2F7;">
                        ...
                        <td class="col th-type-1">Название Услуги</td>
                        <td class="col th-type-1">Клиент</td>
                        <td class="col th-type-1">Оценка</td>
                    ...
                    <tr class="">
                        ...
                        <td class="col th-type-1 text-grey-3 text-nunito fs-14 fw-light">Установка на хостинг
                        </td>
                        ...
                        <td class="col th-type-1">
                            <div class="rounded-2 text-center fs-12 fw-bolder col-9"
                                style="background-color: rgba(255, 195, 90, 0.18); color: rgb(255, 195, 90)">На модерации
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td class="col th-type-1 text-grey-3 text-nunito fs-14 fw-light">Исправление ошибки
                        </td>
                        <td class="col th-type-1 text-grey-3 text-nunito fs-15 fw-bolder">Андрей Петрович
                        </td>
                        <td class="col th-type-1 text-grey-3 text-nunito fs-15 fw-bolder">* * * * *</td>
