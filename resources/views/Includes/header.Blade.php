@section('header')
    ...
    <div class="header mx-auto col-12 col-lg-9 navbar-expand-lg">
        <div class="d-flex justify-content-lg-center justify-content-md-between align-items-center text-center text-white navbar-expand-lg"
                ...
                <div class="offcanvas-body text-start mx-4">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="flush-collapseOne" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body mt-2">
                                        {{-- О компании --}}
                                        <a class="text-decor-none" href="{{ route('about') }}">
                                        ...
                                        {{-- Сотрудники --}}
                                        <a class="text-decor-none" href="{{ route('personal') }}">
                                            <div class="d-flex text-nunito col-10 ps-3 py-2"
                                                style="color: #BCCEE4;">
                                        ...
                                        {{-- Отзывы --}}
                                        <a class="text-decor-none" href="{{ route('reviews') }}">
                                            <div class="d-flex text-nunito col-10 ps-3 py-2"
                                                style="color: #BCCEE4;">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="fw-light fs-15 text-montserrat mt-4">
                            ...
                            <span class="fs-17" style="line-height:25px;">г. Сочи, ул. Навагинская 13/1, микрорайон Центральный</span>
                        </div>
                        <div class="col-12 text-montserrat fw-light fs-15 mt-4">
                            ...
                            <span>damir-khaybulin@mail.ru</span>
                        </div>
                        <div class="mt-4">
            ...
            {{-- Номер --}}
            <div class="col-lg-2 col-md-3 collapse navbar-collapse fs-18 fw-bold">
                {{ $contacts->phone}}
            </div>
            {{-- Логотип --}}
            <div
            ...
            <div class="col-lg-3 col-md-5 collapse navbar-collapse">
                ...
                <div class="col-lg-8 col-md-8 d-flex justify-content-end">
                    <button type="button" class="btn btn-primary border-0 col-10 fw-bold"
                        style="background: #365EDC;" data-bs-toggle="modal" data-bs-target="#takerequest">Подать заявку</button>
                </div>
            </div>
        </div>
        {{-- Разделы меню --}}
