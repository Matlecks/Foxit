...
@section('companycontent')
    <div class="d-flex justify-content-between rounded-1 py-5 pe-5"
        style="background: #FAFAFA; border: 1px solid #e5e5e5;">
        <div class="col-8">
            <div class="d-flex justify-content-between col-12 ps-5">
                <div class=" ">
                    <div class="title-over">Должность</div>
                    <div class="fs-19 text-montserrat" style="color: #333333;">{{ $user->job }}</div>
                </div>
                <button type="submit" class="rounded-1 fs-14 fw-bold text-montserrat px-3 py-1"
            ...
            <div class="d-flex justify-content-between ps-5 mt-4">
                <div class="col-4">
                ...
                <div class="col-4 d-flex justify-content-start align-items-center"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 26 26" width="20px"
                        height="20px" fill="currentColor" class="mx-3">
                        <path
                    ...
                    <img class="mx-3" src="/img/vk.png" height="26">
                </div>
            </div>
            <div class="ps-5 mt-4 fs-15 text-montserrat text-darkgrey">
                {!! $user->details_text !!}
            </div>
        </div>
        <div class="rounded-1 col-3" style="height: 300px; width: 300px;">
